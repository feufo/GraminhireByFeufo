              ...
              <div className="grid gap-6 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="name" placeholder="Enter name or organization" />
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-blue-800">55% of total</div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-green-800">40% of total</div>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xs text-orange-800">5% of total</div>
                    </div>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div key={job.id} className="border rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 bg-green-50 rounded-lg">
                        ...
                        <div className="text-sm text-green-800">Institutes</div>
                      </div>
                ...
                <div className="border rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="text-center p-3 bg-yellow-50 rounded-lg">
                      ...
                      <div className="text-sm text-yellow-800">Shortlisted</div>
                    </div>
                    <div className="text-center p-3 bg-purple-50 rounded-lg">
                      <div className="text-xl font-bold text-purple-600">1</div>
                      <div className="text-sm text-purple-800">Interviewed</div>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded-lg">
                ...
                <div className="border rounded-lg p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Recruiting Team: recruiting@bajajauto.com • 3 positions
                        • Mumbai, Maharashtra
                      </p>
                      <p className="text-sm text-muted-foreground">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 bg-yellow-50 rounded-lg">
                        ...
                        <div className="text-sm text-yellow-800">Fill Rate</div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="border rounded-lg p-4 bg-orange-50">
                        ...
                        <div className="text-xs text-orange-700">
                          Pending • ₹{employer.paidAmount.toLocaleString()} paid
                        </div>
                      </div>
                    </div>
        ...
        <TabsContent value="institutes" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
            ...
            <Card className="border-2 border-purple-200">
              <CardContent className="p-6 text-center">
                <Building2 className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                <div className="text-2xl font-bold text-purple-600">
                  {institutes.filter((inst) => inst.status === "active").length}
                </div>
                <div className="text-sm text-muted-foreground">
                  Active Institutes
                </div>
          ...
          <Card className="border-2">
            <CardHeader>
              ...
              <CardDescription>
                CRM-style view of all institutes with placement fees and student
                performance
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                      <div className="border rounded-lg p-4 bg-green-50">
                        ...
                        <div className="text-xs text-green-700">
                          From {institute.placedStudents} successful placements
                        </div>
                      </div>
                      <div className="border rounded-lg p-4 bg-orange-50">
                        <div className="text-sm font-medium text-orange-900 mb-1">
                        ...
                        <div className="text-xs text-orange-700">
                          From {institute.pendingPlacements} pending placements
                        </div>
                      </div>
                      <div className="border rounded-lg p-4 bg-blue-50">
                        <div className="text-sm font-medium text-blue-900 mb-1">
